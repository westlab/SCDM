...
class RpcClient:
    ...
    def restore(self, c_name, need_tmp_dir=False):
        status = self._stub.RestoreContainer(docker_migration_pb2.CheckpointSummary(c_name=c_name, need_tmp_dir=need_tmp_dir))
        return status.code
